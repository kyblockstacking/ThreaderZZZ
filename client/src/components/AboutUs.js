        ...
        return (
            <div className="container">
                ...
                <div className="card" style={card}>
                    <img className="card-img-top" src="/images/aiden.jpg" alt="Profile Picture" />
                ...
                <div className="card" style={card}>
                    <img className="card-img-top" src="/images/david.png" alt="Profile Picture" />
                    <div className="card-body">
                ...
                <div className="card" style={card}>
                    <img className="card-img-top" src="/images/kevin.png" alt="Profile Picture" />
                    <div className="card-body">
                ...
                <div className="card" style={card}>
                    <img className="card-img-top" src="/images/vernie.jpg" alt="Profile Picture" />
                    <div className="card-body">
