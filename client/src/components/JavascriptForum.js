...
class javascriptForum extends React.Component {
    ...
    render() {
        return (
            <div>
                <div style={{ borderRadius: "10px", padding: '10px', background: '#2e849e', color: 'white', width: "60%", marginRight: "auto", marginLeft: "auto", marginBottom: "1em", textAlign: "center" }}>Javascript ThreadZZZ</div>
